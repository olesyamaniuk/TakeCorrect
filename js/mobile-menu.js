document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".e-q-navigation-list");
  const headerRef = document.querySelector(".e-q-header");
  const navigationRef = document.querySelector(".e-q-navigation");
